...
if (!($widgetJobs->get_isbetalinkvalid($_GET['id']))) {
	header("Location: index.php"); 
	die("Redirecting to index.php"); 
}
?>
					...
					<div class="front">
						...
						<form action="register.php" method="post" id="registerform"> 
							<fieldset>
								...
								<input placeholder="Email" type="text" name="email" value="" /> <br/>
								<input placeholder="Password" type="password" name="password" value="" /> 
								<?php echo '<input name="linkid" type="hidden" value="'. $_GET['id'] .'"  />'; ?>
								<input class="btn btn-large btn-info btn-block" type="submit" value="Signup" /> 
							</fieldset>
						</form>
